      ...
      <div className="container mx-auto px-6">
        ...
        >
          <motion.div variants={itemVariants} className="md:w-1/2">
            <h3 className="text-2xl font-semibold font-poppins text-primary mb-6">Contact Information</h3>
            <p className="text-lg text-text mb-8 font-opensans">
              I'm currently available for internship opportunities. Feel free to reach out if you think my skills and experience would be a good fit for your team.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-text">chinmoya@example.com</p>
                </div>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <motion.a
                  whileHover={{ scale: 1.1, backgroundColor: "#E85A4F" }}
                  transition={{ type: "spring", stiffness: 400, damping: 10 }}
                  href="#" 
                  className="bg-primary text-white p-3 rounded-full transition duration-300"
                >
          ...
          <motion.div variants={itemVariants} className="md:w-1/2">
            <h3 className="text-2xl font-semibold font-poppins text-primary mb-6">Send Me a Message</h3>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <motion.button
                ...
                className="bg-accent hover:bg-opacity-90 text-white font-medium py-3 px-6 rounded-lg transition duration-300 w-full md:w-auto disabled:opacity-70"
              >
                {isSubmitting ? (
