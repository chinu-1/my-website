...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects" ref={ref} className="py-24 bg-muted/20">
      <div className="container mx-auto px-6">
        ...
        >
          <span className="inline-block px-3 py-1 text-sm font-medium text-secondary bg-secondary/10 rounded-full mb-3">PROJECTS</span>
        ...
        >
          {projects.map((project, index) => (
            ...
            >
              <div className="h-64 bg-gradient-to-r from-secondary/20 to-accent/20 flex items-center justify-center relative">
                {/* Project icon/symbol */}
                <div className="absolute inset-0 bg-grid-pattern opacity-10"></div>
                <div className="bg-card p-5 rounded-full shadow-lg">
                  <svg 
              ...
              <div className="p-8">
                <h3 className="text-2xl font-bold text-text mb-4 font-raleway">{project.title}</h3>
                <p className="text-text/80 mb-6 font-montserrat leading-relaxed">{project.description}</p>
                ...
                <div className="flex justify-between pt-4 border-t border-border">
                  <motion.a 
                    ...
                    whileHover={{ scale: 1.05, color: "rgb(var(--accent))" }}
                    className="text-text hover:text-accent transition duration-300 inline-flex items-center"
                  >
